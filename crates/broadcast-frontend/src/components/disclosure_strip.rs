    ...
    html! {
        <div style="position:sticky;top:0;z-index:20;background:rgba(0,0,0,.94);border-bottom:1px solid #1a1a1a">
            <div style="padding:0 6%">
                <div style="max-width:1280px;margin:0 auto;display:flex;align-items:center;gap:14px;height:42px">
                    ...
                    <a href="https://wizardsardine.com/blog/coldcard-rng-vulnerability/" target="_blank" style="display:flex;align-items:center;gap:8px;font-size:13.5px;color:#b0def0;text-decoration:none;white-space:nowrap">
                        <span style="text-decoration:underline;text-decoration-color:#4a6470;text-underline-offset:3px">{"Coldcard RNG vulnerability, and why you might need this tool"}</span>
